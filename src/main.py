...
from .window import NyarchwizardWindow


class NyarchwizardApplication(Adw.Application):
    """The main application singleton class."""

    def __init__(self):
        super().__init__(application_id='moe.nyarchlinux.wizard',
    ...
    def do_activate(self):
        ...
        if not win:
            win = NyarchwizardWindow(application=self)
        win.present()
